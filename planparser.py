...
"""
def loadMatData():
	filename = "res/" + input("Network .mat file name? ")
	while not os.path.isfile(filename):
		filename = "res/" + input("File not found, try again: ")
...
destination sinks[i]
"""
def createSourcesAndSinks(finaltrips):
